...
## Project Memory Files (37)

- `04_KICAD_PROJECTS\active\COMMAND_LINK_VERIFIED_REFERENCE\memory\AGENT_MISTAKES_TO_AVOID.md` - Agent Mistakes To Avoid
- `04_KICAD_PROJECTS\active\COMMAND_LINK_VERIFIED_REFERENCE\memory\AI_RELIABILITY_MEMORY.md` - AI Reliability Memory
- `04_KICAD_PROJECTS\active\COMMAND_LINK_VERIFIED_REFERENCE\memory\COMPONENT_DECISIONS.md` - Component Decisions
- `04_KICAD_PROJECTS\active\COMMAND_LINK_VERIFIED_REFERENCE\memory\DATASHEET_DECISIONS.md` - Datasheet Decisions
- `04_KICAD_PROJECTS\active\COMMAND_LINK_VERIFIED_REFERENCE\memory\DESIGN_RULES.md` - Project Design Rules
- `04_KICAD_PROJECTS\active\COMMAND_LINK_VERIFIED_REFERENCE\memory\FOOTPRINT_DECISIONS.md` - Footprint Decisions
- `04_KICAD_PROJECTS\active\COMMAND_LINK_VERIFIED_REFERENCE\memory\MEMORY_UPDATE_RULES.md` - Project Memory Update Rules
...
- `04_KICAD_PROJECTS\active\COMMAND_LINK_VERIFIED_REFERENCE\memory\PROJECT_MEMORY.md` - COMMAND_LINK_VERIFIED_REFERENCE Project Memory
- `04_KICAD_PROJECTS\active\COMMAND_LINK_VERIFIED_REFERENCE\memory\PROJECT_QUALITY_GATE_RULES.md` - Project Quality Gate Rules
- `04_KICAD_PROJECTS\active\COMMAND_LINK_VERIFIED_REFERENCE\memory\PROJECT_UNVERIFIED_CLAIMS.md` - Project Unverified Claims
- `04_KICAD_PROJECTS\active\COMMAND_LINK_VERIFIED_REFERENCE\memory\USER_CORRECTIONS.md` - User Corrections
