# Task Type To Tool Map

Status: `CANONICAL_ROUTER_TOOL_MAP`

Use this after the router picks the task route. Choose the safest local tool
surface first.

| Route | First Tool Surfaces |
| --- | --- |
