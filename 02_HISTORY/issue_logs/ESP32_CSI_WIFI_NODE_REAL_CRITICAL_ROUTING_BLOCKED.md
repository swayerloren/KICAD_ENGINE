...
Real active-board critical routing is being requested before the copied-board rehearsal gate exists and before the routing phase gate is satisfied.

## Evidence

- Missing: `04_KICAD_PROJECTS/active/ESP32_CSI_WIFI_NODE/reports/COPIED_BOARD_CRITICAL_ROUTING_REHEARSAL_REPORT.md`
...
- copied-board critical routing rehearsal must exist and pass
