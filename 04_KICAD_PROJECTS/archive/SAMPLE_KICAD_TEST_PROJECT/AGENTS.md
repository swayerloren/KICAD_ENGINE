...
Project-specific AI agent rules for `SAMPLE_KICAD_TEST_PROJECT`.
...
- Durable project decisions belong in this project's memory folder and in `KICAD_ENGINE/01_MEMORY/projects/SAMPLE_KICAD_TEST_PROJECT/PROJECT_MEMORY.md`.
- Session notes and command results belong in this project's history folder or `KICAD_ENGINE/02_HISTORY/project_history/SAMPLE_KICAD_TEST_PROJECT/`.
