...
Project-specific AI agent rules for `ESP32_CSI_WIFI_NODE`.
...
- Durable project decisions belong in this project's memory folder and in `KICAD_ENGINE/01_MEMORY/projects/ESP32_CSI_WIFI_NODE/PROJECT_MEMORY.md`.
- Session notes and command results belong in this project's history folder or `KICAD_ENGINE/02_HISTORY/project_history/ESP32_CSI_WIFI_NODE/`.
