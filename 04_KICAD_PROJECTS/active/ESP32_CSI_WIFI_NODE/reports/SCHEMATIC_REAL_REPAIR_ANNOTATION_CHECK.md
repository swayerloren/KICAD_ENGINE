...
| `PASS` | `VALUE_PRESENT` | `J1` | Value field is present. | `JACK_5V_REVIEW` |
| `PASS` | `FOOTPRINT_ASSIGNED` | `J1` | Footprint field is populated. | `Connector_BarrelJack:BarrelJack_CUI_PJ-102AH_Horizontal` |
...
| `PASS` | `VALUE_PRESENT` | `F1` | Value field is present. | `PTC_1206_REVIEW` |
| `PASS` | `FOOTPRINT_ASSIGNED` | `F1` | Footprint field is populated. | `Fuse:Fuse_1206_3216Metric` |
| `PASS` | `REFERENCE_PRESENT` | `Q1` | Reference is present and annotated. | `Device:Q_PMOS` |
| `PASS` | `VALUE_PRESENT` | `Q1` | Value field is present. | `AO3401A_REVIEW` |
| `PASS` | `FOOTPRINT_ASSIGNED` | `Q1` | Footprint field is populated. | `Package_TO_SOT_SMD:SOT-23` |
...
| `PASS` | `VALUE_PRESENT` | `D1` | Value field is present. | `SMAJ5V_NEEDS_REVIEW` |
| `PASS` | `FOOTPRINT_ASSIGNED` | `D1` | Footprint field is populated. | `Diode_SMD:D_SMA` |
...
| `PASS` | `VALUE_PRESENT` | `C1` | Value field is present. | `47uF_16V_REVIEW` |
| `PASS` | `FOOTPRINT_ASSIGNED` | `C1` | Footprint field is populated. | `Capacitor_SMD:C_1206_3216Metric` |
...
| `PASS` | `VALUE_PRESENT` | `U1` | Value field is present. | `AP63203_NEEDS_REVIEW` |
| `PASS` | `FOOTPRINT_ASSIGNED` | `U1` | Footprint field is populated. | `Package_TO_SOT_SMD:TSOT-23-6` |
...
| `PASS` | `VALUE_PRESENT` | `L1` | Value field is present. | `3.9uH_IND_REVIEW` |
| `PASS` | `FOOTPRINT_ASSIGNED` | `L1` | Footprint field is populated. | `Inductor_SMD:L_Vishay_IFSC-1515AH_4x4x1.8mm` |
...
| `PASS` | `VALUE_PRESENT` | `C2` | Value field is present. | `10uF_CIN_REVIEW` |
| `PASS` | `FOOTPRINT_ASSIGNED` | `C2` | Footprint field is populated. | `Capacitor_SMD:C_0805_2012Metric` |
...
| `PASS` | `VALUE_PRESENT` | `C3` | Value field is present. | `22uF_COUT_REVIEW` |
| `PASS` | `FOOTPRINT_ASSIGNED` | `C3` | Footprint field is populated. | `Capacitor_SMD:C_1206_3216Metric` |
...
| `PASS` | `VALUE_PRESENT` | `C4` | Value field is present. | `22uF_COUT_REVIEW` |
| `PASS` | `FOOTPRINT_ASSIGNED` | `C4` | Footprint field is populated. | `Capacitor_SMD:C_1206_3216Metric` |
...
| `PASS` | `FOOTPRINT_ASSIGNED` | `C5` | Footprint field is populated. | `Capacitor_SMD:C_0603_1608Metric` |
| `PASS` | `REFERENCE_PRESENT` | `U2` | Reference is present and annotated. | `RF_Module:ESP32-S3-WROOM-1` |
| `PASS` | `VALUE_PRESENT` | `U2` | Value field is present. | `ESP32-S3-WROOM-1U_REVIEW` |
| `PASS` | `FOOTPRINT_ASSIGNED` | `U2` | Footprint field is populated. | `RF_Module:ESP32-S3-WROOM-1` |
...
| `PASS` | `VALUE_PRESENT` | `C6` | Value field is present. | `10uF_MODULE_REVIEW` |
| `PASS` | `FOOTPRINT_ASSIGNED` | `C6` | Footprint field is populated. | `Capacitor_SMD:C_0805_2012Metric` |
...
| `PASS` | `VALUE_PRESENT` | `C7` | Value field is present. | `100nF_MODULE` |
| `PASS` | `FOOTPRINT_ASSIGNED` | `C7` | Footprint field is populated. | `Capacitor_SMD:C_0603_1608Metric` |
...
| `PASS` | `VALUE_PRESENT` | `R1` | Value field is present. | `10k_EN` |
| `PASS` | `FOOTPRINT_ASSIGNED` | `R1` | Footprint field is populated. | `Resistor_SMD:R_0603_1608Metric` |
...
| `PASS` | `VALUE_PRESENT` | `C8` | Value field is present. | `1uF_EN_REVIEW` |
| `PASS` | `FOOTPRINT_ASSIGNED` | `C8` | Footprint field is populated. | `Capacitor_SMD:C_0603_1608Metric` |
...
| `PASS` | `VALUE_PRESENT` | `SW1` | Value field is present. | `RESET_EN_REVIEW` |
| `PASS` | `FOOTPRINT_ASSIGNED` | `SW1` | Footprint field is populated. | `Button_Switch_SMD:Panasonic_EVQPUJ_EVQPUA` |
...
| `PASS` | `VALUE_PRESENT` | `R2` | Value field is present. | `10k_BOOT` |
| `PASS` | `FOOTPRINT_ASSIGNED` | `R2` | Footprint field is populated. | `Resistor_SMD:R_0603_1608Metric` |
...
| `PASS` | `VALUE_PRESENT` | `SW2` | Value field is present. | `BOOT_GPIO0_REVIEW` |
| `PASS` | `FOOTPRINT_ASSIGNED` | `SW2` | Footprint field is populated. | `Button_Switch_SMD:Panasonic_EVQPUJ_EVQPUA` |
...
| `PASS` | `VALUE_PRESENT` | `J2` | Value field is present. | `USB-C_NEEDS_REVIEW` |
| `PASS` | `FOOTPRINT_ASSIGNED` | `J2` | Footprint field is populated. | `Connector_USB:USB_C_Receptacle_GCT_USB4105-xx-A_16P_TopMnt_Horizontal` |
...
| `PASS` | `VALUE_PRESENT` | `R3` | Value field is present. | `0R_DNI_SHIELD_REVIEW` |
| `PASS` | `FOOTPRINT_ASSIGNED` | `R3` | Footprint field is populated. | `Resistor_SMD:R_0603_1608Metric` |
...
| `PASS` | `FOOTPRINT_ASSIGNED` | `R4` | Footprint field is populated. | `Resistor_SMD:R_0603_1608Metric` |
...
| `PASS` | `FOOTPRINT_ASSIGNED` | `R5` | Footprint field is populated. | `Resistor_SMD:R_0603_1608Metric` |
...
| `PASS` | `VALUE_PRESENT` | `U3` | Value field is present. | `USB_ESD_REVIEW` |
| `PASS` | `FOOTPRINT_ASSIGNED` | `U3` | Footprint field is populated. | `Package_TO_SOT_SMD:SOT-23-6` |
...
| `PASS` | `VALUE_PRESENT` | `R6` | Value field is present. | `22R_USB_D-` |
| `PASS` | `FOOTPRINT_ASSIGNED` | `R6` | Footprint field is populated. | `Resistor_SMD:R_0603_1608Metric` |
| `PASS` | `REFERENCE_PRESENT` | `R7` | Reference is present and annotated. | `Device:R` |
| `PASS` | `VALUE_PRESENT` | `R7` | Value field is present. | `22R_USB_D+` |
| `PASS` | `FOOTPRINT_ASSIGNED` | `R7` | Footprint field is populated. | `Resistor_SMD:R_0603_1608Metric` |
| `PASS` | `REFERENCE_PRESENT` | `R8` | Reference is present and annotated. | `Device:R` |
| `PASS` | `VALUE_PRESENT` | `R8` | Value field is present. | `2.2k_PWR` |
| `PASS` | `FOOTPRINT_ASSIGNED` | `R8` | Footprint field is populated. | `Resistor_SMD:R_0603_1608Metric` |
...
| `PASS` | `VALUE_PRESENT` | `D2` | Value field is present. | `PWR_LED_REVIEW` |
| `PASS` | `FOOTPRINT_ASSIGNED` | `D2` | Footprint field is populated. | `LED_SMD:LED_0603_1608Metric` |
...
| `PASS` | `VALUE_PRESENT` | `R9` | Value field is present. | `2.2k_STATUS` |
| `PASS` | `FOOTPRINT_ASSIGNED` | `R9` | Footprint field is populated. | `Resistor_SMD:R_0603_1608Metric` |
| `PASS` | `REFERENCE_PRESENT` | `D3` | Reference is present and annotated. | `Device:LED` |
| `PASS` | `VALUE_PRESENT` | `D3` | Value field is present. | `STATUS_LED_REVIEW` |
| `PASS` | `FOOTPRINT_ASSIGNED` | `D3` | Footprint field is populated. | `LED_SMD:LED_0603_1608Metric` |
...
| `PASS` | `VALUE_PRESENT` | `TP1` | Value field is present. | `TP_5V` |
| `PASS` | `FOOTPRINT_ASSIGNED` | `TP1` | Footprint field is populated. | `TestPoint:TestPoint_Pad_D1.5mm` |
| `PASS` | `REFERENCE_PRESENT` | `TP2` | Reference is present and annotated. | `Connector:TestPoint` |
| `PASS` | `VALUE_PRESENT` | `TP2` | Value field is present. | `TP_3V3` |
| `PASS` | `FOOTPRINT_ASSIGNED` | `TP2` | Footprint field is populated. | `TestPoint:TestPoint_Pad_D1.5mm` |
...
| `PASS` | `VALUE_PRESENT` | `TP3` | Value field is present. | `TP_GND` |
| `PASS` | `FOOTPRINT_ASSIGNED` | `TP3` | Footprint field is populated. | `TestPoint:TestPoint_Pad_D1.5mm` |
...
| `PASS` | `VALUE_PRESENT` | `TP4` | Value field is present. | `TP_EN` |
| `PASS` | `FOOTPRINT_ASSIGNED` | `TP4` | Footprint field is populated. | `TestPoint:TestPoint_Pad_D1.5mm` |
| `PASS` | `REFERENCE_PRESENT` | `TP5` | Reference is present and annotated. | `Connector:TestPoint` |
| `PASS` | `VALUE_PRESENT` | `TP5` | Value field is present. | `TP_BOOT` |
| `PASS` | `FOOTPRINT_ASSIGNED` | `TP5` | Footprint field is populated. | `TestPoint:TestPoint_Pad_D1.5mm` |
| `PASS` | `REFERENCE_PRESENT` | `TP6` | Reference is present and annotated. | `Connector:TestPoint` |
| `PASS` | `VALUE_PRESENT` | `TP6` | Value field is present. | `TP_U0TXD` |
| `PASS` | `FOOTPRINT_ASSIGNED` | `TP6` | Footprint field is populated. | `TestPoint:TestPoint_Pad_D1.5mm` |
| `PASS` | `REFERENCE_PRESENT` | `TP7` | Reference is present and annotated. | `Connector:TestPoint` |
| `PASS` | `VALUE_PRESENT` | `TP7` | Value field is present. | `TP_U0RXD` |
| `PASS` | `FOOTPRINT_ASSIGNED` | `TP7` | Footprint field is populated. | `TestPoint:TestPoint_Pad_D1.5mm` |
| `PASS` | `REFERENCE_PRESENT` | `TP8` | Reference is present and annotated. | `Connector:TestPoint` |
| `PASS` | `VALUE_PRESENT` | `TP8` | Value field is present. | `TP_USB_D+_REVIEW` |
| `PASS` | `FOOTPRINT_ASSIGNED` | `TP8` | Footprint field is populated. | `TestPoint:TestPoint_Pad_D1.5mm` |
| `PASS` | `REFERENCE_PRESENT` | `TP9` | Reference is present and annotated. | `Connector:TestPoint` |
| `PASS` | `VALUE_PRESENT` | `TP9` | Value field is present. | `TP_USB_D-_REVIEW` |
| `PASS` | `FOOTPRINT_ASSIGNED` | `TP9` | Footprint field is populated. | `TestPoint:TestPoint_Pad_D1.5mm` |
| `PASS` | `REFERENCE_PRESENT` | `MH1` | Reference is present and annotated. | `Mechanical:MountingHole` |
| `PASS` | `VALUE_PRESENT` | `MH1` | Value field is present. | `M2.5_NPTH_REVIEW` |
| `PASS` | `FOOTPRINT_ASSIGNED` | `MH1` | Footprint field is populated. | `MountingHole:MountingHole_2.7mm_M2.5` |
| `PASS` | `REFERENCE_PRESENT` | `MH2` | Reference is present and annotated. | `Mechanical:MountingHole` |
| `PASS` | `VALUE_PRESENT` | `MH2` | Value field is present. | `M2.5_NPTH_REVIEW` |
| `PASS` | `FOOTPRINT_ASSIGNED` | `MH2` | Footprint field is populated. | `MountingHole:MountingHole_2.7mm_M2.5` |
| `PASS` | `REFERENCE_PRESENT` | `MH3` | Reference is present and annotated. | `Mechanical:MountingHole` |
| `PASS` | `VALUE_PRESENT` | `MH3` | Value field is present. | `M2.5_NPTH_REVIEW` |
| `PASS` | `FOOTPRINT_ASSIGNED` | `MH3` | Footprint field is populated. | `MountingHole:MountingHole_2.7mm_M2.5` |
| `PASS` | `REFERENCE_PRESENT` | `MH4` | Reference is present and annotated. | `Mechanical:MountingHole` |
| `PASS` | `VALUE_PRESENT` | `MH4` | Value field is present. | `M2.5_NPTH_REVIEW` |
| `PASS` | `FOOTPRINT_ASSIGNED` | `MH4` | Footprint field is populated. | `MountingHole:MountingHole_2.7mm_M2.5` |
