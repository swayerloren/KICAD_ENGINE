...
| `PASS` | `VALUE_PRESENT` | `J1` | Value field is present. | `JACK_5V` |
...
| `PASS` | `VALUE_PRESENT` | `F1` | Value field is present. | `PTC_1206` |
...
| `PASS` | `VALUE_PRESENT` | `Q1` | Value field is present. | `AO3401A_REV` |
...
| `PASS` | `VALUE_PRESENT` | `D1` | Value field is present. | `TVS_NEEDS_REVIEW` |
...
| `PASS` | `VALUE_PRESENT` | `C1` | Value field is present. | `47uF_16V` |
...
| `PASS` | `VALUE_PRESENT` | `L1` | Value field is present. | `3.9uH_REV` |
...
| `PASS` | `VALUE_PRESENT` | `C2` | Value field is present. | `10uF_IN` |
...
| `PASS` | `VALUE_PRESENT` | `C3` | Value field is present. | `22uF_OUT` |
...
| `PASS` | `VALUE_PRESENT` | `C4` | Value field is present. | `22uF_OUT` |
...
| `PASS` | `VALUE_PRESENT` | `U2` | Value field is present. | `ESP32-S3-WROOM-1U` |
...
| `PASS` | `VALUE_PRESENT` | `C6` | Value field is present. | `10uF_MOD` |
...
| `PASS` | `VALUE_PRESENT` | `C7` | Value field is present. | `100nF_MOD` |
...
| `PASS` | `VALUE_PRESENT` | `C8` | Value field is present. | `1uF_EN` |
...
| `PASS` | `VALUE_PRESENT` | `R3` | Value field is present. | `0R_DNI` |
...
| `PASS` | `VALUE_PRESENT` | `U3` | Value field is present. | `USB_ESD_REV` |
...
| `PASS` | `VALUE_PRESENT` | `R6` | Value field is present. | `22R_D-` |
...
| `PASS` | `VALUE_PRESENT` | `R7` | Value field is present. | `22R_D+` |
...
| `PASS` | `VALUE_PRESENT` | `R8` | Value field is present. | `2.2k` |
...
| `PASS` | `VALUE_PRESENT` | `R9` | Value field is present. | `2.2k` |
...
| `PASS` | `VALUE_PRESENT` | `D3` | Value field is present. | `STATUS_LED` |
...
| `PASS` | `VALUE_PRESENT` | `TP8` | Value field is present. | `TP_D+_REV` |
...
| `PASS` | `VALUE_PRESENT` | `TP9` | Value field is present. | `TP_D-_REV` |
...
| `PASS` | `VALUE_PRESENT` | `MH1` | Value field is present. | `M2.5_NPTH` |
...
| `PASS` | `VALUE_PRESENT` | `MH2` | Value field is present. | `M2.5_NPTH` |
...
| `PASS` | `VALUE_PRESENT` | `MH3` | Value field is present. | `M2.5_NPTH` |
...
| `PASS` | `VALUE_PRESENT` | `MH4` | Value field is present. | `M2.5_NPTH` |
