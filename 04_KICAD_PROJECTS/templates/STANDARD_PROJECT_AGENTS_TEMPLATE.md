...
Project-specific AI agent rules for `PROJECT_NAME`.
...
- Durable project decisions belong in this project's memory folder and in `KICAD_ENGINE/01_MEMORY/projects/PROJECT_NAME/PROJECT_MEMORY.md`.
- Session notes and command results belong in this project's history folder or `KICAD_ENGINE/02_HISTORY/project_history/PROJECT_NAME/`.
