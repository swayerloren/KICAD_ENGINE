# MICROCHIP_AVR Needs Review

Date: 2026-05-03
Status: `OPEN_REVIEW_BACKLOG`

This is the blocker list for promoting `MICROCHIP_AVR` content beyond planning.
...
| --- | --- | --- |
| exact representative part datasheet | `NEEDS_HUMAN_REVIEW` | official vendor datasheet for `ATMEGA328P` |
...
Any project using `ATMEGA328P` must keep schematic-to-PCB promotion blocked until required reviews are complete or explicitly accepted by a human.
