# MICROCHIP_AVR KiCad Symbol And Footprint Notes

Date: 2026-05-03
Status: `CANDIDATE_ONLY`

This file records KiCad library candidates for `MICROCHIP_AVR`. Candidate existence is not datasheet verification.
