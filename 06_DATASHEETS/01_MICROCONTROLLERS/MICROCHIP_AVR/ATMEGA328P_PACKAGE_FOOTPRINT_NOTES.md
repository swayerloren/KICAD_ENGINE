# ATMEGA328P Package And Footprint Notes

Date: 2026-05-03
Status: `NEEDS_HUMAN_REVIEW`

This file records package and footprint evidence for `ATMEGA328P`. It starts with no approved footprint.
...
| --- | --- | --- | --- |
| orderable part | `ATMEGA328P` | `UNKNOWN_REQUIRES_SOURCE` | `UNVERIFIED` |
