...
Path: `06_DATASHEETS\01_MICROCONTROLLERS\RASPBERRY_PI_RP2040_RP2350`

## Purpose

This folder stores source-link-first datasheet metadata, AI-readable design notes, part-level checklists, and KiCad symbol/footprint risk notes for `RP2040_RP2350`.
...
- Keep unknown fields marked `UNKNOWN_REQUIRES_SOURCE`.
