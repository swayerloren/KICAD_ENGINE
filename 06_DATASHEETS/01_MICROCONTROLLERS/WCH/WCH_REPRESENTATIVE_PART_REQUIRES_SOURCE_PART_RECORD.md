# WCH-REPRESENTATIVE_PART_REQUIRES_SOURCE Part Record
...
| Field | Value | Status |
| --- | --- | --- |
| manufacturer | `WCH` | `UNVERIFIED` |
| part_number | `WCH-REPRESENTATIVE_PART_REQUIRES_SOURCE` | `UNVERIFIED` |
| family | `WCH` | `UNVERIFIED` |
