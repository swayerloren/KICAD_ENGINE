...
Path: `06_DATASHEETS\01_MICROCONTROLLERS\WCH`

## Purpose

This folder stores source-link-first datasheet metadata, AI-readable design notes, part-level checklists, and KiCad symbol/footprint risk notes for `WCH`.
