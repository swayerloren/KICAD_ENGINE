# ATMEL_LEGACY KiCad Symbol And Footprint Notes

Date: 2026-05-03
Status: `CANDIDATE_ONLY`

This file records KiCad library candidates for `ATMEL_LEGACY`. Candidate existence is not datasheet verification.
