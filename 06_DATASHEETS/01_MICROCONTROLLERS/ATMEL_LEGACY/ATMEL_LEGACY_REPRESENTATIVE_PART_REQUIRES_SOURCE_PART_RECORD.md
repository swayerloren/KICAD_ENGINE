# ATMEL-LEGACY-REPRESENTATIVE_PART_REQUIRES_SOURCE Part Record
...
| Field | Value | Status |
| --- | --- | --- |
| manufacturer | `ATMEL_LEGACY` | `UNVERIFIED` |
| part_number | `ATMEL-LEGACY-REPRESENTATIVE_PART_REQUIRES_SOURCE` | `UNVERIFIED` |
| family | `ATMEL_LEGACY` | `UNVERIFIED` |
