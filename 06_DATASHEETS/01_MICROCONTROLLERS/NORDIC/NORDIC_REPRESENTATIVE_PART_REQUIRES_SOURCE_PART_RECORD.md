# NORDIC-REPRESENTATIVE_PART_REQUIRES_SOURCE Part Record
...
| Field | Value | Status |
| --- | --- | --- |
| manufacturer | `NORDIC` | `UNVERIFIED` |
| part_number | `NORDIC-REPRESENTATIVE_PART_REQUIRES_SOURCE` | `UNVERIFIED` |
| family | `NORDIC` | `UNVERIFIED` |
