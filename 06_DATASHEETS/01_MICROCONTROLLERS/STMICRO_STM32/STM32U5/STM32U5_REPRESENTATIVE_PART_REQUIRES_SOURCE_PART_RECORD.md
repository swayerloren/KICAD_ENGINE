# STM32U5-REPRESENTATIVE_PART_REQUIRES_SOURCE Part Record
...
| Field | Value | Status |
| --- | --- | --- |
| manufacturer | `STMICRO_STM32` | `UNVERIFIED` |
| part_number | `STM32U5-REPRESENTATIVE_PART_REQUIRES_SOURCE` | `UNVERIFIED` |
| family | `STM32U5` | `UNVERIFIED` |
