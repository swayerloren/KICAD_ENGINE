...
Modern ultra-low-power STM32 family for secure, battery-powered, high-integration products.

Core class: Arm Cortex-M33 ultra-low-power security/performance family-level class; exact part and SMPS options require verification.
...
USB, OCTOSPI, SDMMC, FDCAN, and other peripherals vary. Security and power mode choices affect bring-up.
...
Verify analog domains, VREF/VDDA/VSSA, ADC, VCAP/SMPS/LDO pins, and exact package power requirements.
...
| Source | Link | Use |
| Official family page | https://www.st.com/en/microcontrollers-microprocessors/stm32u5-series.html | Primary family landing page and document gateway. |
