# STM32L1 Package And Footprint Notes
...
- UFQFPN/QFN and WLCSP on selected parts
...
Every `STM32L1` footprint selection is `HUMAN_REVIEW_REQUIRED` until exact package drawing comparison is complete.
