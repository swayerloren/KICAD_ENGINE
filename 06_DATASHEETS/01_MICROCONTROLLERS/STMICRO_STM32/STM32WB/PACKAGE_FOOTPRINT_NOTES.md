# STM32WB Package And Footprint Notes
...
- UFQFPN/QFN
- WLCSP/BGA
- module options on selected products
...
Every `STM32WB` footprint selection is `HUMAN_REVIEW_REQUIRED` until exact package drawing comparison is complete.
