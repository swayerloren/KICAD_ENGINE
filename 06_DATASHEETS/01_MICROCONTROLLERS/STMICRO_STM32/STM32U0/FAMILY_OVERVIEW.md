...
Newer low-power entry STM32 family for compact products needing current ST ecosystem support.

Core class: Arm Cortex-M0+ ultra-low-power entry family-level class; exact part set requires current ST source verification.
...
- STM32U031
- STM32U073
- STM32U083 - verify current ST selector for exact family list
...
Family-level package examples: UFQFPN/QFN, LQFP, TSSOP or WLCSP on selected parts.
...
USB and security/peripheral options vary. Do not copy G0/F0 assumptions without exact U0 source review.
...
Verify analog supply/reference behavior, low-power modes, and package pin mapping.
...
| Source | Link | Use |
| Official family page | https://www.st.com/en/microcontrollers-microprocessors/stm32u0-series.html | Primary family landing page and document gateway. |
