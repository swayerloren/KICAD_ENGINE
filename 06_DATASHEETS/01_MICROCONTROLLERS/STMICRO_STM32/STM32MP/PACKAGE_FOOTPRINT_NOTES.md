# STM32MP Package And Footprint Notes
...
- BGA packages dominate; exact package, ball map, DDR escape, PMIC, and layout stackup require source verification
...
Every `STM32MP` footprint selection is `HUMAN_REVIEW_REQUIRED` until exact package drawing comparison is complete.
