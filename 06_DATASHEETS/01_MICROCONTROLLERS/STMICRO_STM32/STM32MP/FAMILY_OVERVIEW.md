...
Linux-capable STM32 MPU family for application processors with DDR, PMIC, high-speed interfaces, and complex board design.

Core class: STM32 microprocessor family-level class; not a simple MCU. Exact Cortex-A/M core mix requires product verification.
...
- STM32MP1 series
- STM32MP2 series - verify exact product line and lifecycle status
...
Family-level package examples: BGA packages dominate; exact package, ball map, DDR escape, PMIC, and layout stackup require source verification.
...
Ethernet, USB, display, camera, SDMMC, and high-speed interfaces are board-level design tasks with impedance, power, and software constraints.
...
Treat analog notes as board-level power-management and signal-integrity review. Exact rails and PMIC sequencing are mandatory.
...
| Source | Link | Use |
| Official family page | https://www.st.com/en/microcontrollers-microprocessors/stm32mp1-series.html | Primary family landing page and document gateway. |
| Official secondary family page | https://www.st.com/en/microcontrollers-microprocessors/stm32mp2-series.html | Secondary STM32MP family source page. |
