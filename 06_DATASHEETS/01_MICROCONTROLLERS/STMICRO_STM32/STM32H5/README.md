...
Path: `06_DATASHEETS\01_MICROCONTROLLERS\STMICRO_STM32\STM32H5`

## Purpose

This folder stores source-link-first datasheet metadata, AI-readable design notes, part-level checklists, and KiCad symbol/footprint risk notes for `STM32H5`.
