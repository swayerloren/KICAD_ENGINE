...
Modern secure STM32 family for connected products needing stronger security and mid/high performance.

Core class: Arm Cortex-M33 security/performance family-level class; exact security and memory set require part verification.
...
Family-level package examples: UFQFPN/QFN, LQFP, UFBGA/BGA on selected parts.
...
USB, CAN/FDCAN, Ethernet, and security features vary by exact part. Confirm secure boot/debug policy before board lock-in.
...
Verify analog rails, reference pins, ADC capability, and package pin mapping in the exact datasheet.
...
| Source | Link | Use |
| Official family page | https://www.st.com/en/microcontrollers-microprocessors/stm32h5-series.html | Primary family landing page and document gateway. |
