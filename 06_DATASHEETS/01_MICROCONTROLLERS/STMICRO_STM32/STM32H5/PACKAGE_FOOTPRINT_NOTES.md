# STM32H5 Package And Footprint Notes
...
Every `STM32H5` footprint selection is `HUMAN_REVIEW_REQUIRED` until exact package drawing comparison is complete.
