# STM32F1 Package And Footprint Notes
...
- LQFP
- BGA on larger connectivity parts
- VFQFPN/QFN on selected parts
...
Every `STM32F1` footprint selection is `HUMAN_REVIEW_REQUIRED` until exact package drawing comparison is complete.
