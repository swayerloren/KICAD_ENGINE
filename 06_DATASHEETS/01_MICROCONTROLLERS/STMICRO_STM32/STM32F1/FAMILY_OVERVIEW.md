...
Mature mainstream STM32 family used in many legacy and prototype designs.

Core class: Arm Cortex-M3 family-level class; exact subfamily and peripheral set require part verification.
...
Family-level package examples: LQFP, BGA on larger connectivity parts, VFQFPN/QFN on selected parts.
...
USB FS and CAN exist on common variants but not every part/package. F105/F107 connectivity-line behavior must be checked from the exact reference manual.
...
Analog capability is useful but older. Verify ADC channel pins, VDDA/VSSA/VREF, and package pinout.
...
| Source | Link | Use |
| Official family page | https://www.st.com/en/microcontrollers-microprocessors/stm32f1-series.html | Primary family landing page and document gateway. |
