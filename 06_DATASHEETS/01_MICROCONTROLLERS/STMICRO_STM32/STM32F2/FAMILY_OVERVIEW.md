...
Higher-performance Cortex-M3 STM32 family bridging older F1-class designs and later F4/F7 families.

Core class: Arm Cortex-M3 high-performance family-level class; exact capabilities require part verification.
...
USB, CAN, Ethernet, and external memory support are part/package dependent. Confirm pins and PHY requirements.
...
Verify ADC, DAC, VDDA/VSSA/VREF, backup domain, and package pin mux from exact datasheet.
...
| Source | Link | Use |
| Official family page | https://www.st.com/en/microcontrollers-microprocessors/stm32f2-series.html | Primary family landing page and document gateway. |
