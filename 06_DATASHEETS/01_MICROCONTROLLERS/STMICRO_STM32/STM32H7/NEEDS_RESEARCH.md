...
- Official/shared source rows available for this family: 12
- Part index rows available for this family: 18
- Exact official product-page rows currently marked `OFFICIAL_SOURCE_LINK`: 2
- Family-specific dev board/schematic rows currently indexed: 3
