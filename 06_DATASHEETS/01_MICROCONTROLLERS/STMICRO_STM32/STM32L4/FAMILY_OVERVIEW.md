...
Ultra-low-power performance STM32 family for battery products needing more compute and richer peripherals.

Core class: Arm Cortex-M4 ultra-low-power family-level class; exact memory/peripheral set requires part verification.
...
Family-level package examples: UFQFPN/QFN, LQFP, BGA/WLCSP on selected parts.
...
USB, CAN, SDMMC, and other interfaces vary. USB clock/recovery behavior must be checked per part.
...
Verify ADC/DAC/op-amp/comparator availability, VDDA/VSSA/VREF, and low-power analog behavior.
...
| Source | Link | Use |
| Official family page | https://www.st.com/en/microcontrollers-microprocessors/stm32l4-series.html | Primary family landing page and document gateway. |
