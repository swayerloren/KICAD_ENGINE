# STM32G0 Package And Footprint Notes
...
- SO/TSSOP on selected low-pin-count parts
- UFQFPN/QFN
- LQFP
- WLCSP on selected parts
...
Every `STM32G0` footprint selection is `HUMAN_REVIEW_REQUIRED` until exact package drawing comparison is complete.
