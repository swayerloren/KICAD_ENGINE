...
Ultra-low-power STM32 family for battery sensors, low-duty-cycle products, and RTC-centric nodes.

Core class: Arm Cortex-M0+ ultra-low-power family-level class; exact low-power modes require part verification.
...
Family-level package examples: TSSOP, UFQFPN/QFN, LQFP, WLCSP on selected parts.
...
USB and low-power communication support vary. Do not assume USB on low-power variants.
...
Low-leakage analog, VDDA/VSSA, VREF, and sensor biasing require careful review.
...
| Source | Link | Use |
| Official family page | https://www.st.com/en/microcontrollers-microprocessors/stm32l0-series.html | Primary family landing page and document gateway. |
