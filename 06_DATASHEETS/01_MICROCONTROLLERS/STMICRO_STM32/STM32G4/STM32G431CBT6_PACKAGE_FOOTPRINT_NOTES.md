# STM32G431CBT6 Package And Footprint Notes

Date: 2026-05-03
Status: `NEEDS_HUMAN_REVIEW`

This file records package and footprint evidence for `STM32G431CBT6`. It starts with no approved footprint.
...
| --- | --- | --- | --- |
| orderable part | `STM32G431CBT6` | `UNKNOWN_REQUIRES_SOURCE` | `UNVERIFIED` |
