# GIGADEVICE-REPRESENTATIVE_PART_REQUIRES_SOURCE Part Record
...
| Field | Value | Status |
| --- | --- | --- |
| manufacturer | `GIGADEVICE` | `UNVERIFIED` |
| part_number | `GIGADEVICE-REPRESENTATIVE_PART_REQUIRES_SOURCE` | `UNVERIFIED` |
| family | `GIGADEVICE` | `UNVERIFIED` |
