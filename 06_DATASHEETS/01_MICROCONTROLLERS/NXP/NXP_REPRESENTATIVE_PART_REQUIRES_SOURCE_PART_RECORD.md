# NXP-REPRESENTATIVE_PART_REQUIRES_SOURCE Part Record
...
| Field | Value | Status |
| --- | --- | --- |
| manufacturer | `NXP` | `UNVERIFIED` |
| part_number | `NXP-REPRESENTATIVE_PART_REQUIRES_SOURCE` | `UNVERIFIED` |
| family | `NXP` | `UNVERIFIED` |
