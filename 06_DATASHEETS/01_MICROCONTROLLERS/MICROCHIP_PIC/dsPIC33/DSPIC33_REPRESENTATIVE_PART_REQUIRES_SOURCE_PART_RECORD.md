# dsPIC33-REPRESENTATIVE_PART_REQUIRES_SOURCE Part Record
...
| Field | Value | Status |
| --- | --- | --- |
| manufacturer | `MICROCHIP_PIC` | `UNVERIFIED` |
| part_number | `dsPIC33-REPRESENTATIVE_PART_REQUIRES_SOURCE` | `UNVERIFIED` |
| family | `dsPIC33` | `UNVERIFIED` |
