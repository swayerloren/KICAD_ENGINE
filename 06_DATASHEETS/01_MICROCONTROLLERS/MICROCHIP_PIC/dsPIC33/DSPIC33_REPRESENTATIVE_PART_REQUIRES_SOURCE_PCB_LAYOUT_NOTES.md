# dsPIC33-REPRESENTATIVE_PART_REQUIRES_SOURCE PCB Layout Notes

Date: 2026-05-03
Status: `AI_PLANNING_CHECKLIST`

These notes define PCB layout review topics for `dsPIC33-REPRESENTATIVE_PART_REQUIRES_SOURCE`. They are not placement, routing, or fabrication approval until exact source evidence and human review are recorded.
