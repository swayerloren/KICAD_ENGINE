...
This is the blocker list for promoting `PIC16` content beyond planning.
...
| --- | --- | --- |
| exact representative part datasheet | `NEEDS_HUMAN_REVIEW` | official vendor datasheet for `PIC16F877A` |
...
Any project using `PIC16F877A` must keep schematic-to-PCB promotion blocked until required reviews are complete or explicitly accepted by a human.
