...
This is the blocker list for promoting `PIC18` content beyond planning.
...
| --- | --- | --- |
| exact representative part datasheet | `NEEDS_HUMAN_REVIEW` | official vendor datasheet for `PIC18F4550` |
...
Any project using `PIC18F4550` must keep schematic-to-PCB promotion blocked until required reviews are complete or explicitly accepted by a human.
