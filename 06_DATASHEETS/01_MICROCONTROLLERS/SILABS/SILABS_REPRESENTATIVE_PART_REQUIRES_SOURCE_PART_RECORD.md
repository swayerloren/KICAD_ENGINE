# SILABS-REPRESENTATIVE_PART_REQUIRES_SOURCE Part Record
...
| Field | Value | Status |
| --- | --- | --- |
| manufacturer | `SILABS` | `UNVERIFIED` |
| part_number | `SILABS-REPRESENTATIVE_PART_REQUIRES_SOURCE` | `UNVERIFIED` |
| family | `SILABS` | `UNVERIFIED` |
