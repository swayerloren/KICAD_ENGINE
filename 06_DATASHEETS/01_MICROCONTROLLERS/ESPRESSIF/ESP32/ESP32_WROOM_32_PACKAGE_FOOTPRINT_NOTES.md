# ESP32-WROOM-32 Package And Footprint Notes

Date: 2026-05-03
Status: `NEEDS_HUMAN_REVIEW`

This file records package and footprint evidence for `ESP32-WROOM-32`. It starts with no approved footprint.
...
| --- | --- | --- | --- |
| orderable part | `ESP32-WROOM-32` | `UNKNOWN_REQUIRES_SOURCE` | `UNVERIFIED` |
