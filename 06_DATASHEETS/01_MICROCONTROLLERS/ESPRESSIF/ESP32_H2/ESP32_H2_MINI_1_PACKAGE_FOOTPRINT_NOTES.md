# ESP32-H2-MINI-1 Package And Footprint Notes

Date: 2026-05-03
Status: `NEEDS_HUMAN_REVIEW`

This file records package and footprint evidence for `ESP32-H2-MINI-1`. It starts with no approved footprint.
...
| --- | --- | --- | --- |
| orderable part | `ESP32-H2-MINI-1` | `UNKNOWN_REQUIRES_SOURCE` | `UNVERIFIED` |
