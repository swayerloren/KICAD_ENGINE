# ESP8266EX Package And Footprint Notes

Date: 2026-05-03
Status: `NEEDS_HUMAN_REVIEW`

This file records package and footprint evidence for `ESP8266EX`. It starts with no approved footprint.
...
| --- | --- | --- | --- |
| orderable part | `ESP8266EX` | `UNKNOWN_REQUIRES_SOURCE` | `UNVERIFIED` |
