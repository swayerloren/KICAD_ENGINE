...
Path: `06_DATASHEETS\01_MICROCONTROLLERS\ESPRESSIF\ESP32_C2`

## Purpose

This folder stores source-link-first datasheet metadata, AI-readable design notes, part-level checklists, and KiCad symbol/footprint risk notes for `ESP32_C2`.
