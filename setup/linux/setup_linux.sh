...
if [ "$OFFER_INSTALL" = "true" ]; then
  "$SCRIPT_DIR/install_missing_linux_tools.sh" --apply
fi
...
echo "Linux setup completed. Review reports under 05_OUTPUTS before trusting the environment."
